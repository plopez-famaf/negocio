...
class CommandInterface {
    ...
    createInterface() {
        ...
        // Output area
        this.outputBox = blessed_1.default.box({
            parent: this.container,
            top: 3,
            left: 0,
            right: 0,
        ...
        // Input area
        const inputContainer = blessed_1.default.box({
            parent: this.container,
            bottom: 0,
            left: 0,
            right: 0,
        ...
        // Command input
        this.inputBox = blessed_1.default.textarea({
            parent: inputContainer,
            top: 1,
            left: 13,
            right: 1,
...
`;
    ...
    async executeThreatGuardCommand(command) {
        return new Promise((resolve, reject) => {
            // Parse command
            const args = command.split(' ');
            // Execute using node process (simulating CLI execution)
            const child = (0, child_process_1.spawn)('node', ['-e', `
