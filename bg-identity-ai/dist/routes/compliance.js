...
router.post('/report', auth_1.authMiddleware, async (req, res) => {
    try {
...
router.post('/validate', auth_1.authMiddleware, async (req, res) => {
    try {
...
router.post('/data-processing', auth_1.authMiddleware, async (req, res) => {
    try {
        ...
        logger_1.logger.info('Data processing activity recorded', {
...
router.post('/consent', async (req, res) => {
    try {
        ...
        logger_1.logger.info('User consent recorded', {
