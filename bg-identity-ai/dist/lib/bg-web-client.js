...
exports.bgWebClient = exports.BgWebClient = void 0;
...
class BgWebClient {
    ...
    constructor() {
        ...
        this.client.interceptors.request.use((config) => {
            logger_1.logger.info('Making request to bg-web API', {
        ...
        this.client.interceptors.response.use((response) => {
            logger_1.logger.info('Received response from bg-web API', {
                component: 'bg-web-client',
            ...
            logger_1.logger.error('Response interceptor error', {
                component: 'bg-web-client',
        ...
        logger_1.logger.info('BgWebClient initialized', {
            component: 'bg-web-client',
            baseUrl: this.baseUrl,
            correlationId: this.correlationId,
        });
     ...
     */
    async createThreatEvent(eventId, threatData, userId) {
        try {
            ...
            if (response.data.success) {
                logger_1.logger.info('Threat event created successfully', {
                    component: 'bg-web-client',
            ...
            logger_1.logger.error('Failed to create threat event', {
                component: 'bg-web-client',
                action: 'create_threat_event',
                eventId,
                correlationId: this.correlationId,
    ...
    async queryThreatEvents(filters = {}) {
        try {
            ...
            logger_1.logger.error('Failed to query threat events', {
                component: 'bg-web-client',
     ...
     */
    async updateThreatEventStatus(eventId, status) {
        try {
            const response = await this.client.patch(`/api/threat/events/${eventId}/status`, {
                status,
            });
            if (response.data.success) {
                logger_1.logger.info('Threat event status updated', {
                    component: 'bg-web-client',
            ...
            logger_1.logger.error('Failed to update threat event status', {
                component: 'bg-web-client',
                action: 'update_threat_status',
                eventId,
                status,
    ...
    async getThreatStatistics(timeRange) {
        try {
            ...
            logger_1.logger.error('Failed to get threat statistics', {
                component: 'bg-web-client',
    ...
    async testConnection() {
        try {
            ...
            if (response.status === 200) {
                logger_1.logger.info('bg-web connection test successful', {
                    component: 'bg-web-client',
            ...
            logger_1.logger.error('bg-web connection test failed', {
                component: 'bg-web-client',
                action: 'test_connection',
                correlationId: this.correlationId,
                error: error.message,
    ...
    updateAuthToken(token) {
        ...
        logger_1.logger.info('Authentication token updated', {
            component: 'bg-web-client',
            correlationId: this.correlationId,
        });
    }
...
exports.BgWebClient = BgWebClient;
// Export singleton instance
exports.bgWebClient = new BgWebClient();
//# sourceMappingURL=bg-web-client.js.map